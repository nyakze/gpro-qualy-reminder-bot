...
validation-group-invalid-format = Neplatný formát skupiny. Použijte: E, M1-5, P1-25, A1-80, R1-150
validation-group-e-no-numbers = Elite skupina nemá číslované skupiny (použijte 'E')
validation-group-range-m = Master skupina musí být 1-5
validation-group-range-p = Pro skupina musí být 1-25
validation-group-range-a = Amateur skupina musí být 1-80
validation-group-range-r = Rookie skupina musí být 1-150
