...
timezone-menu-title = ⏰ **Настройки часового пояса**
    ...
    Введите ваш часовой пояс (название города, аббревиатуру или смещение UTC):

    Примеры: `Москва`, `MSK`, `UTC+3`, `London`
...
error-timezone-not-found = ❌ Часовой пояс не найден для "{ $query }"
    ...
    Попробуйте: название города (Москва), аббревиатуру (MSK), или смещение UTC (UTC+3)
