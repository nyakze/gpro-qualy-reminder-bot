...
start-welcome-onboarding = 👋 <b>Добро пожаловать в GPRO Bot!</b>
...
admin-calendar-update-failed = ❌ Не удалось обновить календарь. Текущие данные сохранены; попробуйте ещё раз позже.
...
feedback-language-reset = ✅ Язык сброшен на { $language }
...
feedback-skip-language = ⏭️ Используется автоматически определённый язык: { $language }
...
validation-group-invalid-format = Неверный формат группы. Используйте: E, M1-5, P1-25, A1-80, R1-250
validation-group-e-no-numbers = Elite группа не имеет номеров (используйте 'E')
validation-group-range-m = Master группа должна быть 1-5
validation-group-range-p = Pro группа должна быть 1-25
validation-group-range-a = Amateur группа должна быть 1-80
validation-group-range-r = Rookie группа должна быть 1-150
...
# =======================
# Напоминание о новом сезоне
# =======================
notif-category-season-prep = Подготовка к сезону

notif-label-new-season-reminder = Напоминание о новом сезоне

notif-new-season-reminder = 🌟 <b>Начинается новый сезон!</b>
    ...
    💡 Если вы перешли в другую группу, обновите её в /settings для получения персонализированных ссылок!

notif-new-season-reminder-no-group = 🌟 <b>Начинается новый сезон!</b>

    🏁 <b>Гонка #{ $raceId }</b>
    📍 <b>{ $track }</b>
    🏎 <b>Гонка: { $raceTime }</b>

    ⚠️ Вы ещё не указали свою группу!

    💡 Укажите группу в /settings для получения персонализированных ссылок на гонки!
