...
notif-quali-closed-title = <b>Kwalificatie is momenteel gesloten</b>

notif-quali-closed-message = { $emoji } { $title }

    🏁 <b>Race #{ $raceId }</b>
    📍 <b>{ $track }</b>
    ⏰ <b>Kwalificatie gesloten: { $qualiDeadline }</b>
    🏎 <b>Race: { $raceTime }</b>

    ⏳ <i>De kwalificatie is momenteel gesloten. De volgende kwalificatiesessie gaat open na afloop van de huidige race. Wacht tot de race is berekend.</i>
...
validation-group-invalid-format = Ongeldig groepsformaat. Gebruik: E, M1-5, P1-25, A1-80, R1-250
validation-group-e-no-numbers = Elite groep heeft geen genummerde groepen (gebruik 'E')
validation-group-range-m = Master groep moet 1-5 zijn
validation-group-range-p = Pro groep moet 1-25 zijn
validation-group-range-a = Amateur groep moet 1-80 zijn
validation-group-range-r = Rookie groep moet 1-150 zijn
