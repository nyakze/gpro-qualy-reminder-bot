...
start-welcome-onboarding = 👋 <b>Ласкаво просимо до GPRO Bot!</b>
...
onboard-group-custom = 🏁 <b>Вибір Групи (Опціонально)</b>
    ...
    💡 <i>Мову веб-сайту GPRO встановлено на англійську, оскільки сайт GPRO наразі не підтримує вашу мову. Ви зможете змінити її пізніше в /settings.</i>
...
button-snooze-5m = 🔔🔁 +5хв
button-snooze-15m = 🔔🔁 +15хв
button-snooze-30m = 🔔🔁 +30хв
button-snooze-1h = 🔔🔁 +1год
button-snooze-2h = 🔔🔁 +2год
button-snooze-4h = 🔔🔁 +4год
button-snooze-8h = 🔔🔁 +8год
...
notif-quali-opens = <b>Кваліфікація відкрита</b>
...
notif-snooze-title = <b>Нагадування (відтерміновано)</b>
...
notif-quali-closed-title = <b>Кваліфікація наразі закрита</b>

notif-quali-closed-message = { $emoji } { $title }

    🏁 <b>Гонка #{ $raceId }</b>
    📍 <b>{ $track }</b>
    ⏰ <b>Кваліфікацію закрито: { $qualiDeadline }</b>
    🏎 <b>Гонка: { $raceTime }</b>

    ⏳ <i>Кваліфікація наразі закрита. Наступна сесія кваліфікації відкриється після завершення поточної гонки. Будь ласка, зачекайте, поки гонку буде розраховано.</i>
...
feedback-language-reset = ✅ Мову скинуто до { $language }
...
feedback-skip-language = ⏭️ Використовується автоматично визначена мова: { $language }
...
snooze-confirmed = 🔁⏰ Нагадування перенесено на { $time }
snooze-max-reached = 🔁❌ Ліміт відтермінування досягнуто (3/3)
snooze-past-deadline = 🔁❌ Неможливо відтермінувати після дедлайну
snooze-past-next = 🔁❌ Наступне нагадування через { $minutes }хв
...
validation-group-invalid-format = Невірний формат групи. Використовуйте: E, M1-5, P1-25, A1-80, R1-250
...
feedback-switched-to-app = Режим APP увімкнено
feedback-switched-to-classic = Класичний режим увімкнено
...
# =======================
# Нагадування про новий сезон
# =======================
notif-category-season-prep = Підготовка до сезону

notif-label-new-season-reminder = Нагадування про новий сезон

notif-new-season-reminder = 🌟 <b>Новий сезон починається!</b>

    🏁 <b>Гонка #{ $raceId }</b>
    📍 <b>{ $track }</b>
    🏎 <b>Гонка: { $raceTime }</b>

    Ваша поточна група: <b>{ $group }</b>

    💡 Якщо ви перейшли до іншої групи, оновіть її в /settings для отримання персональних посилань!

notif-new-season-reminder-no-group = 🌟 <b>Новий сезон починається!</b>

    🏁 <b>Гонка #{ $raceId }</b>
    📍 <b>{ $track }</b>
    🏎 <b>Гонка: { $raceTime }</b>

    ⚠️ Ви ще не встановили свою групу!

    💡 Встановіть свою групу в /settings для отримання персональних посилань на гонки!
