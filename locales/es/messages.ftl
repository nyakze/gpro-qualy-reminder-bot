...
start-welcome-onboarding = 👋 <b>¡Bienvenido a GPRO Bot!</b>
...
button-enable-category = 🔔 Activar Categoría
button-disable-category = 🔕 Desactivar Categoría
...
# Notificaciones
# =======================
notif-category-before-qualifying = Antes de la Clasificación
notif-category-qualifying-events = Eventos de Clasificación
notif-category-race-events = Eventos de Carrera
...
notif-quali-opens = <b>La clasificación está abierta</b>
...
notif-snooze-title = <b>Recordatorio (pospuesto)</b>
...
notif-quali-closed-title = <b>Clasificación cerrada actualmente</b>

notif-quali-closed-message = { $emoji } { $title }

    🏁 <b>Carrera #{ $raceId }</b>
    📍 <b>{ $track }</b>
    ⏰ <b>Clasificación cerrada: { $qualiDeadline }</b>
    🏎 <b>Carrera: { $raceTime }</b>

    ⏳ <i>La clasificación está cerrada actualmente. La próxima sesión de clasificación se abrirá después de que se complete la carrera actual. Por favor espere a que se calcule la carrera.</i>
...
notif-race-replay = 📺 <b>Repetición de la Carrera #{ $raceId } Disponible</b>
    ...
    Mira la repetición de la carrera:
...
error-invalid-category = ❌ Categoría inválida
...
feedback-category-enabled = ✅ ¡{ $category } activada!
feedback-category-disabled = ✅ ¡{ $category } desactivada!
...
feedback-language-reset = ✅ Idioma restablecido a { $language }
...
feedback-skip-language = ⏭️ Usando idioma detectado automáticamente: { $language }
...
snooze-confirmed = 🔁⏰ Recordatorio movido a { $time }
snooze-max-reached = 🔁❌ Límite de posponer alcanzado (3/3)
snooze-past-deadline = 🔁❌ No se puede posponer después del plazo
snooze-past-next = 🔁❌ Próximo recordatorio en { $minutes }min
...
validation-group-invalid-format = Formato de grupo inválido. Usa: E, M1-5, P1-25, A1-80, R1-250
validation-group-e-no-numbers = El grupo Elite no tiene grupos numerados (usa 'E')
validation-group-range-m = El grupo Master debe ser 1-5
validation-group-range-p = El grupo Pro debe ser 1-25
validation-group-range-a = El grupo Amateur debe ser 1-80
validation-group-range-r = El grupo Rookie debe ser 1-150
...
# =======================
# Recordatorio Nueva Temporada
# =======================
notif-category-season-prep = Preparación Temporada

notif-label-new-season-reminder = Recordatorio nueva temporada

notif-new-season-reminder = 🌟 <b>¡Nueva Temporada Comienza!</b>

    🏁 <b>Carrera #{ $raceId }</b>
    📍 <b>{ $track }</b>
    🏎 <b>Carrera: { $raceTime }</b>

    Tu grupo actual: <b>{ $group }</b>

    💡 Si has cambiado de grupo, actualízalo en /settings para recibir enlaces personalizados!

notif-new-season-reminder-no-group = 🌟 <b>¡Nueva Temporada Comienza!</b>

    🏁 <b>Carrera #{ $raceId }</b>
    📍 <b>{ $track }</b>
    🏎 <b>Carrera: { $raceTime }</b>

    ⚠️ ¡Aún no has configurado tu grupo!

    💡 Configura tu grupo en /settings para recibir enlaces de carrera personalizados!
