...
start-welcome-onboarding = 👋 <b>Benvenuto in GPRO Bot!</b>

    Scegli la lingua del bot:
...
admin-calendar-update-failed = ❌ Aggiornamento del calendario non riuscito. I dati esistenti sono stati conservati; riprova più tardi.
...
feedback-language-reset = ✅ Lingua reimpostata su { $language }
...
feedback-skip-language = ⏭️ Uso della lingua rilevata automaticamente: { $language }
...
validation-group-invalid-format = Formato gruppo non valido. Usa: E, M1-5, P1-25, A1-80, R1-250
validation-group-e-no-numbers = Gruppo Elite non ha gruppi numerati (usa 'E')
validation-group-range-m = Gruppo Master deve essere 1-5
validation-group-range-p = Gruppo Pro deve essere 1-25
validation-group-range-a = Gruppo Amateur deve essere 1-80
validation-group-range-r = Gruppo Rookie deve essere 1-150
...
feedback-switched-to-app = Modalità APP attivata
feedback-switched-to-classic = Modalità Classica attivata
